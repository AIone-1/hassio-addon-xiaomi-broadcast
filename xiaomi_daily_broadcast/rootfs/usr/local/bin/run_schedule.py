...
var TPL_GROUPS=[
  ...
  {title:'温度',fields:[
    ...
    {k:'temp_exclude_balcony',label:'阳台不参与高温报警',ph:'阳台夏天温度高，勾选后不提醒',def:true,type:'check'},
    {k:'temp_exclude_rooms',label:'不参与温度报警的房间',ph:'填房间名，多个用顿号隔开。如：厨房、储物间',def:'',type:'text'},
  ]},
  {title:'湿度',fields:[
    {k:'humidity_dry',label:'干燥阈值(%)',ph:'湿度低于这个值提醒干燥',def:40,type:'number'},
    {k:'humidity_wet',label:'过湿阈值(%)',ph:'湿度高于这个值提醒过湿',def:80,type:'number'},
    {k:'humidity_exclude_rooms',label:'不参与湿度报警的房间',ph:'填房间名，多个用顿号隔开。如：卫生间',def:'',type:'text'},
  ]},
  {title:'用电',fields:[
