...
<div class=\"page\" id=\"page-cfg\">
  <div class=\"card\">
    ...
    <div class=\"row\">
      <select id=\"cfg-speaker\" style=\"width:98%;box-sizing:border-box;padding:8px 10px;border-radius:6px;background:var(--bg-inset);color:var(--text);border:1px solid var(--border)\"></select>
    </div>
  </div>
  <div class=\"card\">
